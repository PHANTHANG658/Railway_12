...
public class ínerrthongtinbang {
...
//	   Nếu không thì sẽ in ra text "Phòng ban của nhân viên này là ..."
		if (Account2.Department == null) {
			...
			System.out.println("phong ban nay co nhan vien la " + Account1.Department.departmentName);
		}
		/*
...
//		  In ra thông tin các account bao gồm: Email, FullName và tên phòng ban của hoj
		...
		for (Account account : accounts) {
			System.out.println("email:" + account.email + "id: " + account.id + "departmentname:"
